<x-admin-layout>
    <div class="w-full">
        ...
        <form method="POST" action="{{ route('admin.posts.update', $post) }}" class="bg-white p-8 rounded-lg shadow border border-gray-200 space-y-6" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="12" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 markdown-editor" required>{{ old('content', $post->content) }}</textarea>
                    </div>
                </div>
                <div class="space-y-6">
                    <div>
