        ...
        <div class="bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
            ...
            <div class="p-8 space-y-6">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/3">
                        @if($post->image_path)
                            <img src="{{ $post->image_path }}" alt="{{ $post->title }}" class="w-full h-auto rounded-lg shadow-sm border border-gray-200">
                        @else
                            <div class="w-full h-48 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400 text-sm italic border border-gray-200">
                                No image provided
                            </div>
                        @endif
                    ...
                    <div class="md:w-2/3 space-y-4">
                        ...
                        <p class="text-gray-600 italic">{{ $post->description }}</p>
